...
from tools import WriteToExcel
...
def get_Chongqing_data(start_date = '20180101', end_date ='20201206', pages = 749):
    ...
    WriteToExcel('Chongqing data 20200114.xlsx','data', page_data.T)
    return page_data.T
